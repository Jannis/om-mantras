...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__16110,opts){
var map__16111 = p__16110;
var map__16111__$1 = ((((!((map__16111 == null)))?((((map__16111.cljs$lang$protocol_mask$partition0$ & (64))) || (map__16111.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16111):map__16111);
var files = cljs.core.get.call(null,map__16111__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___16117 = arguments.length;
var i__6153__auto___16118 = (0);
while(true){
if((i__6153__auto___16118 < len__6152__auto___16117)){
args__6159__auto__.push((arguments[i__6153__auto___16118]));

var G__16119 = (i__6153__auto___16118 + (1));
i__6153__auto___16118 = G__16119;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__16115){
var vec__16116 = p__16115;
var opts = cljs.core.nth.call(null,vec__16116,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__16116,opts){
return (function (evt){
...
});})(conn,vec__16116,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__16116,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__16116,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__16116,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq16113){
var G__16114 = cljs.core.first.call(null,seq16113);
var seq16113__$1 = cljs.core.next.call(null,seq16113);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__16114,seq16113__$1);
});
