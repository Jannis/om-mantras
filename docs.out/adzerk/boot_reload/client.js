...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__16414,opts){
...
var files = cljs.core.get.call(null,map__16415__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___16421 = arguments.length;
var i__6153__auto___16422 = (0);
while(true){
if((i__6153__auto___16422 < len__6152__auto___16421)){
args__6159__auto__.push((arguments[i__6153__auto___16422]));

var G__16423 = (i__6153__auto___16422 + (1));
i__6153__auto___16422 = G__16423;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__16419){
var vec__16420 = p__16419;
var opts = cljs.core.nth.call(null,vec__16420,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__16420,opts){
return (function (evt){
...
});})(conn,vec__16420,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__16420,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__16420,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__16420,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq16417){
var G__16418 = cljs.core.first.call(null,seq16417);
var seq16417__$1 = cljs.core.next.call(null,seq16417);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__16418,seq16417__$1);
});
