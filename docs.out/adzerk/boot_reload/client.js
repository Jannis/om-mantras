...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__16153,opts){
...
var files = cljs.core.get.call(null,map__16154__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___16160 = arguments.length;
var i__6153__auto___16161 = (0);
while(true){
if((i__6153__auto___16161 < len__6152__auto___16160)){
args__6159__auto__.push((arguments[i__6153__auto___16161]));

var G__16162 = (i__6153__auto___16161 + (1));
i__6153__auto___16161 = G__16162;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__16158){
var vec__16159 = p__16158;
var opts = cljs.core.nth.call(null,vec__16159,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__16159,opts){
return (function (evt){
...
});})(conn,vec__16159,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__16159,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__16159,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__16159,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq16156){
var G__16157 = cljs.core.first.call(null,seq16156);
var seq16156__$1 = cljs.core.next.call(null,seq16156);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__16157,seq16156__$1);
});
