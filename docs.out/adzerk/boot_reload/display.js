...
return (function (p__16631){
var vec__16632 = p__16631;
var attr = cljs.core.nth.call(null,vec__16632,(0),null);
var v = cljs.core.nth.call(null,vec__16632,(1),null);
...
var args16633 = [];
var len__6152__auto___16636 = arguments.length;
var i__6153__auto___16637 = (0);
while(true){
if((i__6153__auto___16637 < len__6152__auto___16636)){
args16633.push((arguments[i__6153__auto___16637]));

var G__16638 = (i__6153__auto___16637 + (1));
i__6153__auto___16637 = G__16638;
continue;
} else {
}
break;
...
var len__6152__auto___16641 = arguments.length;
var i__6153__auto___16642 = (0);
while(true){
if((i__6153__auto___16642 < len__6152__auto___16641)){
args__6159__auto__.push((arguments[i__6153__auto___16642]));

var G__16643 = (i__6153__auto___16642 + (1));
i__6153__auto___16642 = G__16643;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq16640){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16640));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__16644){
var map__16648 = p__16644;
var map__16648__$1 = ((((!((map__16648 == null)))?((((map__16648.cljs$lang$protocol_mask$partition0$ & (64))) || (map__16648.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16648):map__16648);
var data = map__16648__$1;
var message = cljs.core.get.call(null,map__16648__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__16648__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__16648__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__16650 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__16650,goog.events.EventType.CLICK,((function (G__16650,map__16648,map__16648__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__16650,map__16648,map__16648__$1,data,message,line,file))
);

return G__16650;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__16651){
var map__16655 = p__16651;
var map__16655__$1 = ((((!((map__16655 == null)))?((((map__16655.cljs$lang$protocol_mask$partition0$ & (64))) || (map__16655.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16655):map__16655);
var data = map__16655__$1;
var message = cljs.core.get.call(null,map__16655__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__16655__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__16655__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__16657 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__16657,goog.events.EventType.CLICK,((function (G__16657,map__16655,map__16655__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__16657,map__16655,map__16655__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__16658){
var map__16662 = p__16658;
...
var messages = map__16662__$1;
var warnings = cljs.core.get.call(null,map__16662__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__16662__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__16664 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__16664,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__16664,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__16665){
var map__16668 = p__16665;
...
var messages = map__16668__$1;
var warnings = cljs.core.get.call(null,map__16668__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__16668__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__16668,map__16668__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__16668,map__16668__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__16668,map__16668__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__16668,map__16668__$1,messages,warnings,exception))
;
...
}catch (e16671){if((e16671 instanceof Error)){
var __16672 = e16671;
} else {
throw e16671;
