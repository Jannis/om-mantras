...
var len__6226__auto___18127 = arguments.length;
var i__6227__auto___18128 = (0);
while(true){
if((i__6227__auto___18128 < len__6226__auto___18127)){
args__6233__auto__.push((arguments[i__6227__auto___18128]));

var G__18129 = (i__6227__auto___18128 + (1));
i__6227__auto___18128 = G__18129;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq18126){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq18126));
});
/**
...
var vec__18131 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18131,(0),null);
var words = cljs.core.nthnext(vec__18131,(1));
...
var G__18133 = clojure.set.rename_keys(m,kmap);
var G__18133__$1 = ((cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__18133,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys):G__18133);
return G__18133__$1;
} else {
return m;
}
...
var args__6233__auto__ = [];
var len__6226__auto___18136 = arguments.length;
var i__6227__auto___18137 = (0);
while(true){
if((i__6227__auto___18137 < len__6226__auto___18136)){
args__6233__auto__.push((arguments[i__6227__auto___18137]));

var G__18138 = (i__6227__auto___18137 + (1));
i__6227__auto___18137 = G__18138;
continue;
} else {
}
break;
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__18134_SHARP_){
if(cljs.core.list_QMARK_(p1__18134_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__18134_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__18134_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq18135){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq18135));
});
/**
...
var vec__18142 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18142,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18142,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__18142,tag_name,names){
return (function (p1__18139_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__18139_SHARP_));
});})(matches,vec__18142,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__18142,tag_name,names){
return (function (p1__18140_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__18140_SHARP_));
});})(matches,vec__18142,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__18143){
var vec__18146 = p__18143;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18146,(0),null);
var content = cljs.core.nthnext(vec__18146,(1));
...
var vec__18147 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18147,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18147,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18147,(2),null);
