...
return m__5750__auto__.call(null,x);
} else {
var m__5750__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__5750__auto____$1 == null))){
return m__5750__auto____$1.call(null,x);
} else {
...
var len__6152__auto___17949 = arguments.length;
var i__6153__auto___17950 = (0);
while(true){
if((i__6153__auto___17950 < len__6152__auto___17949)){
args__6159__auto__.push((arguments[i__6153__auto___17950]));

var G__17951 = (i__6153__auto___17950 + (1));
i__6153__auto___17950 = G__17951;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq17948){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17948));
});
/**
...
var vec__17953 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__17953,(0),null);
var words = cljs.core.nthnext.call(null,vec__17953,(1));
...
var G__17955 = clojure.set.rename_keys.call(null,m,kmap);
var G__17955__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__17955,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__17955);
return G__17955__$1;
} else {
return m;
}
...
var args__6159__auto__ = [];
var len__6152__auto___17958 = arguments.length;
var i__6153__auto___17959 = (0);
while(true){
if((i__6153__auto___17959 < len__6152__auto___17958)){
args__6159__auto__.push((arguments[i__6153__auto___17959]));

var G__17960 = (i__6153__auto___17959 + (1));
i__6153__auto___17959 = G__17960;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__17956_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__17956_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17956_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__17956_SHARP_)){
return p1__17956_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17956_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq17957){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17957));
});
/**
...
var vec__17964 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__17964,(0),null);
var names = cljs.core.nth.call(null,vec__17964,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17964,tag_name,names){
return (function (p1__17961_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__17961_SHARP_));
});})(matches,vec__17964,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17964,tag_name,names){
return (function (p1__17962_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__17962_SHARP_));
});})(matches,vec__17964,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__17965){
var vec__17968 = p__17965;
var tag = cljs.core.nth.call(null,vec__17968,(0),null);
var content = cljs.core.nthnext.call(null,vec__17968,(1));
...
var vec__17969 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__17969,(0),null);
var id = cljs.core.nth.call(null,vec__17969,(1),null);
var class$ = cljs.core.nth.call(null,vec__17969,(2),null);
