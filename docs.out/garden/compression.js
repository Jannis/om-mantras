 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__23628){
var vec__23630 = p__23628;
var tag = cljs.core.nth.call(null,vec__23630,(0),null);
var re = cljs.core.nth.call(null,vec__23630,(1),null);
return ((function (vec__23630,tag,re){
return (function (s){
...
var len__6152__auto___23633 = arguments.length;
var i__6153__auto___23634 = (0);
while(true){
if((i__6153__auto___23634 < len__6152__auto___23633)){
args__6159__auto__.push((arguments[i__6153__auto___23634]));

var G__23635 = (i__6153__auto___23634 + (1));
i__6153__auto___23634 = G__23635;
continue;
} else {
}
break;
...
return p1__23631_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq23632){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23632));
});
/**
...
var map__23639 = temp__4423__auto__;
...
var tag = cljs.core.get.call(null,map__23639__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__23639__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__23639__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__23642 = cljs.core.subs.call(null,s1,size);
var G__23643 = [cljs.core.str(s2),cljs.core.str((function (){var G__23641 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__23641) {
case "l-brace":
return "}";
